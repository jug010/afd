...
public class MailDispatcherServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String toEmail = "ENTER TO EMAIL HERE"; //BLANKED THIS OUT
        String username = "ENTER USERNAME HERE";  //BLANKED THIS OUT
        String password = "ENTER PASSWORD HERE"; //BLANKED THIS OUT
