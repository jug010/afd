	...
	<body id="top">
		...
		<!-- Need to use https://codepen.io/Guilh/pen/JLKbn for the tablet view!!! -->
			<nav id="navigation" class="sticky-nav-off">
				<a name="top"></a>
					<ul class="topnav" id="myTopnav">
					  <!--<li><a class="active" href="#top" onclick="navFunction()"></a></li>-->
                      ...
                      <li class="icon"><a href="javascript:void(0);" style="font-size:15px;" onclick="navFunction()">☰</a></li>
					</ul>
			...
			<div id="main">
				...
				<!-- One -->
					<section id="one">
						<img src="images/afd_logo.png" class="image fit2 thumb" alt="" />
						<header class="major">
							<h2>The Difference is Quality...</h2>
						</header>
					...
					<section id="three">
						...
						<div class="row">
							<div class="8u 12u$(small)">
								<form name="emailForm" method="post" action="MailDispatcherServlet">
									<div class="row uniform 50%">
										...
										<div class="12u$"><textarea name="message" id="message" placeholder="Message" rows="4"></textarea></div>
                                                                ...
                                                                <ul class="actions">
									<li style="padding-top:1em; margin-left:-0.5em"><input onclick="clearForm();" type="submit" value="Send Message" /></li>
								</ul>
								</form>
							...
							<div class="4u$ 12u$(small)">
								<ul class="labeled-icons">
										...
										13609 NE 126th Pl #100<br />
										Kirkland, WA 98034<br />
										<a href="https://www.google.com/maps/place/Advanced+Floor+Design/@47.7139868,-122.1587114,17z/data=!3m1!4b1!4m2!3m1!1s0x549011df5079ad79:0x6811854061610253" target="_blank"><img src="images/maps-icon.png"> Map</a>
									</li>
									<li>
										<h3 class="icon fa-mobile"><span class="label">Phone</span></h3>
										(425) 481-5195
									</li>                                                                                                                               <li>
										<h3 class="icon fa-mobile"><span class="label">Fax</span></h3>
										(425) 814-2112
									</li>
									<li>
										<h3 class="icon fa-envelope-o"><span class="label">Email</span></h3>
										<a href="mailto:awalsh@advancedfloor.net">awalsh@advancedfloor.net</a>
									</li>
								</ul>
							</div>
						</div>
